  ...
  return (
    ...
    >
      ...
      <div style={{ flexShrink: 0 }}>
        ...
        >
          ...
          <span
            style={{
              fontWeight: 600,
              color: isOver ? "#ef4444" : isWarning ? "#f59e0b" : "var(--text)",
            }}
          >
            {count} / {limit}
          </span>
      ...
      {Object.keys(byWidget).length > 0 && (
        <div style={{ flexShrink: 0 }}>
          <div
            style={{ fontSize: 11, color: "var(--text-dim)", marginBottom: 5 }}
          >
            By widget
          </div>
...
const widget: Widget = {
  manifest: {
    ...
    name: "API Tracker",
    description:
      "Tracks net.fetch calls from all widgets and warns when approaching your configured rate limit.",
    version: "0.1.0",
    icon: "📡",
    defaultSize: { w: 5, h: 9 },
    minSize: { w: 4, h: 5 },

...
describe("CURRENT_VERB", () => {
  ...
  it("uses Reading for book", () =>
    expect(CURRENT_VERB["book"]).toBe("Reading"));
  it("uses Playing for game", () =>
    expect(CURRENT_VERB["game"]).toBe("Playing"));
  it("uses Listening for podcast", () =>
    expect(CURRENT_VERB["podcast"]).toBe("Listening"));
});
...
describe("MIGRATIONS", () => {
  ...
  it("starts empty (no post-v1 migrations yet)", () =>

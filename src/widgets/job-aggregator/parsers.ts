...
export function parseLeverXML(xmlText: string, feedName: string): ParsedFeedJob[] {
...
export function parseRSSXML(xmlText: string, feedName: string): ParsedFeedJob[] {
  const doc = new DOMParser().parseFromString(xmlText, 'application/xml');
...
export function parseGreenhouseJSON(jsonText: string, feedName: string): ParsedFeedJob[] {

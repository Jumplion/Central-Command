...
import { googleGetToken, googleIsConnected } from './google-oauth';
...
export class DriveSync {
  async isConnected(): Promise<boolean> {
    return googleIsConnected(SHARED_GOOGLE_WIDGET_ID, DRIVE_SYNC_SERVICE);
  }
  ...
  private async getToken(): Promise<string> {
    const token = await googleGetToken(SHARED_GOOGLE_WIDGET_ID, DRIVE_SYNC_SERVICE);
